...
responses_dict = { "Reply_of_greet": ["Hello!","Hi!","Hey!","Hola!","Namaste!","Namaskar!","Vanakkam!","Bonjour!","Jai Shree Krishna!","Jai Shree Ram!","Jai Shree Ganesh!","Jai Shree Hanuman!","Jai Shree Sai Ram!","Jai Shree Radhe!","Radhe Radhe!","Har Har Shambhu!","Har Har Mahadev!"],
                  ...
                  "Reply_of_query_about_creater": ["My creater is DJ(Dhruv Jaiswal)",
                                                   "I am created by DJ(Dhruv Jaiswal)",
                                                   "DJ(Dhruv Jaiswal) is my creater",
                                                   "DJ(Dhruv Jaiswal) is my developer",
                                                   "DJ(Dhruv Jaiswal) is my coder",
                                                   "DJ(Dhruv Jaiswal) is my programmer",
                                                   "DJ(Dhruv Jaiswal) is my designer",
                                                   "DJ(Dhruv Jaiswal) is my builder",
                                                   "DJ(Dhruv Jaiswal) is my manufacturer",
                                                   "DJ(Dhruv Jaiswal) is my inventor",
                                                   "DJ(Dhruv Jaiswal) is my author",
                                                   "DJ(Dhruv Jaiswal) is my father",
                                                   "DJ(Dhruv Jaiswal) is my mother",
                                                   "DJ(Dhruv Jaiswal) is my parent",
                                                   "DJ(Dhruv Jaiswal) is my god",
                                                   "DJ(Dhruv Jaiswal) is my godfather",
                                                   "DJ(Dhruv Jaiswal) is my godmother",
                                                   "DJ(Dhruv Jaiswal) is my godparent",
                                ],
